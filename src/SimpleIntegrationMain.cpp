...
int main(int argc, char** argv) {
	...
	const double tstep = 1e-14;
	const double w = tstep;
	int numberOfCycles = 4;

	ConstantsDescriptor config(w01, w12, wt, w, T, tstep, theta, theta, numberOfCycles, 0.0001, 3, 0);
	Kernel kernel(config);
	string sequence = "11-1-1-1110-1-1110-1111-1-1111-1-1111-1-111-1-1-1111-1-1111-1-1111-1-1111-1-1111-1-1111-1-1111-1-1111-1-1111-1-1-111-1-1011-1-1111-1-111-1-1-111-1-1-111-1-1-11";
